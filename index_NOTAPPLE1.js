...
$(document).ready(function () {
  ...
  $("#micBtn").on("click", () => {
    ...
    if (  micEnabled ) $("#micBtn").removeClass("btn-light").addClass("btn-danger");
  ...
  $("#spkBtn").on("click", () => {
    ...
    if (  speakerEnabled ) $("#spkBtn").removeClass("btn-light").addClass("btn-warning");
    else $("#spkBtn").removeClass("btn-warning").addClass("btn-light");
  });
